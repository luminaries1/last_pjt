<template>
  <div class="container">
    ...
    <button @click="deleteCommunity" class="btn btn-outline-success button-border mx-2">Delete</button>
    <button @click="updateCommunity" class="btn btn-outline-success button-border mx-2">Update</button>
